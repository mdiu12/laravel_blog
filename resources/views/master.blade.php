    ...
    <nav id="menu" class="navbar container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="#">
				<div class="logo"><span>কক্সবাজার টেলিগ্রাম</span></div>
			</a>
		</div>
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav">
                ...
                {
                ?>
                <li><a href="{{URL::to('/category-news/'.$v_category_info->id)}}">{{$v_category_info->category_name}}</a></li>
                <?php } ?> 
				...
				<li><a href="{{URL::to('/contact')}}"><i class="fa fa-envelope"></i> ঠিকানা</a></li>
			</ul>
