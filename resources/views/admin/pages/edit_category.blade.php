         ...
         {!! Form::open(array('url' => '/update-category','method'=>'post','name'=>'edit_category','class'=>'form-horizontal')) !!}
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Edit Category Name</label>
							  <div class="controls">
								<input name="category_name" value="{{$category_info->category_name}}"type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4">
                                <input name="id" value="{{$category_info->id}}"type="hidden" >
